...
describe('api routes', () => {
    ...
    test('google calendar route redirects to a prefilled calendar event', async () => {
        ...
        expect(res.redirect).toHaveBeenCalledWith(expect.stringContaining('https://calendar.google.com/calendar/render?'));
        expect(res.redirect).toHaveBeenCalledWith(expect.stringContaining('action=TEMPLATE'));
        expect(res.redirect).toHaveBeenCalledWith(expect.stringContaining('text=DevOps+demo'));
        expect(res.redirect).toHaveBeenCalledWith(expect.stringContaining('dates=20260525T103000%2F20260525T113000'));
    });
});
